...
<footer class="site-footer"><div><h3>從從農農｜花生一生</h3><p>來自雲林元長的花生品牌。</p></div><div><h4>網站導覽</h4><a href="../about.html">品牌理念</a><a href="../products.html">產品介紹</a><a href="../contact.html">聯絡我們</a></div></footer><script src="../js/main.js?v=20260712"></script><script src="../js/cart-ui.js?v=20260712"></script></body></html>`;
}
