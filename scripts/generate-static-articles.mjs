...
const absoluteImage = (value = "") => {
  ...
  return normalized ? `${siteUrl}/${normalized}` : `${siteUrl}/images/articles/article-placeholder.webp`;
};
...
function renderArticle(post) {
  ...
  const jsonLd = JSON.stringify({ "@context": "https://schema.org", "@type": "Article", headline: post.title, description, image: [image], datePublished: date, dateModified: updated, mainEntityOfPage: canonical, author: { "@type": "Organization", name: "花生一生" }, publisher: { "@type": "Organization", name: "花生一生", logo: { "@type": "ImageObject", url: `${siteUrl}/images/logo.webp` } } }).replaceAll("<", "\\u003c");
  return `<!DOCTYPE html>
...
<meta name="twitter:card" content="summary_large_image"><script type="application/ld+json">${jsonLd}</script><link rel="icon" href="../icons/icon.webp">
<link rel="stylesheet" href="../css/style.css?v=20260712"><link rel="stylesheet" href="../css/footer.css"><link rel="stylesheet" href="../css/mobile.css"><link rel="stylesheet" href="../css/cart-ui.css"><link rel="stylesheet" href="../css/brand-system.css?v=1"><link rel="stylesheet" href="../css/article.css?v=20260715-2"><link rel="stylesheet" href="../css/palette-system.css?v=20260807-font-fix"><link rel="stylesheet" href="../css/site-wa.css?v=20260902-2"></head>
<body><header class="site-header"><a href="../index.html" class="logo-area"><img src="../images/logo.webp" alt="花生一生 Logo"></a><button class="menu-toggle" id="menuToggle" aria-label="開啟網站選單" aria-controls="siteNav" aria-expanded="false">☰</button><nav class="site-nav" id="siteNav" aria-label="主要導覽"><a href="../index.html">首頁</a><a href="../about.html">品牌理念</a><a href="../life.html">花生的一生</a><a href="../products.html">產品介紹</a><a href="../knowledge.html">花生知識</a><a href="../order.html" data-purchase-link>前往購買</a><a href="../contact.html">聯絡我們</a></nav></header>
